...
exports.help = function () {
  return `
    ...
    If you have any problems, do not hesitate to file an issue:
      ${chalk.cyan('https://github.com/billymoon/create-awesome/issues/new')}
  `
}
...
exports.start = function (projectName) {
  ...
  const commands = {
    ...
    build: yarn ? 'yarn build' : 'npm run build',
    start: yarn ? 'yarn start' : 'npm run start',
    dev: yarn ? 'yarn dev' : 'npm run dev'
  }
  ...
  ${chalk.green('https://github.com/billymoon/create-awesome/issues')}
`
}
